...
const Schedule = () => {
    ...
    piketGroup = [
        ["Adzka", "Alan", "Attar", "Ardan", "Bagas", "Banu", "Kesya", "Irul"],
        ["Devan", "Wahyu", "Fakhri", "Varvan", "Hanafi", "Rafi", "Akmal",],
        ["Wisnu", "Dafyan", "Haikal", "Akbar", "Gavra", "Fidah", "Abel",],
        ["Dhaffa", "Fadel", "Rayden", "Danis", "Danang", "Chafif", "Fathan", "Kinan",],
        ["Mengikuti Jadwal Minggu Piket Jum'at"],
    ]
