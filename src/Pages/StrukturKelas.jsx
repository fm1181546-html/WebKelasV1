    ...
    return (
        <div className="z-1 relative h-auto lg:overflow-hidden">
            ...
            <div data-aos="fade-up" data-aos-duration="500" className="mt-14 md:mt-10">
                <BorderStruktur Jabatan="Wali Kelas" Nama="Yeva Purnama S.Pd" Width="150px" />
            </div>
            <div className="flex flex-col justify-center items-center">
                ...
                <div
                    ...
                    <div className="flex-col">
                        <BorderStruktur Jabatan="Kebersihan" Nama="Fathan" Width="120px" />
                        <div className="py-[3%]"></div>
                    </div>
                </div>
                ...
                <div
                    ...
                    <div className="flex-col">
                        <BorderStruktur Jabatan="Bendahara" Nama="Abel" Width="120px" />
                        <div className="py-[3%]"></div>
                    </div>

                    {/* Bagian tengah Keamanan Fathan & line vertikal ke bawah sudah dihapus dari sini */}

                    <div className="flex-col">
                        <BorderStruktur Jabatan="Bendahara 2" Nama="Kesya" Width="120px" />
                        <div className="py-[3%]"></div>
                    </div>
                </div>
