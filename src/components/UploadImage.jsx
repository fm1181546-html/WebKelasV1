      ...
      <div className="mx-auto p-4">
        <form>
          <div className="mb-4">
            ...
            <label
              htmlFor="imageUpload"
              className="cursor-pointer border-dashed border-2 border-gray-400 rounded-lg p-3 w-full max-w-[16rem] sm:w-56 aspect-square flex items-center justify-center overflow-hidden">
              {imageUpload ? (
